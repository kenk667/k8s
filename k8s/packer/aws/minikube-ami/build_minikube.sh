...
set -x
set -e
ARTIFACT_PREFIX='minikube' # <= change this to what you're building, e.g. concourse
...
sed -i "s/ami-${FIRST_VAR}/ami-${SECOND_VAR}/g" ../../../terraform/aws/minikube-deployment/variables.tf 
